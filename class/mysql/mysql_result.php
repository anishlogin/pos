...
Class mysql_result{
    ...
    */
     ...
     */
    function __construct($sql="", $result = null){
        if($result===null){
            return false;
        }
     ...
     *
     * @see mysql_result::$_default_result_type
     * @see mysql_result::fetchObject()
     * @see mysql_result::fetchArray()
    */
    function fetch(){
    ...
    */
     ...
     * @see mysql_result::fetchAllObject()
    */
    function getObject(){
        return $this->fetchAllObject();
    }
     ...
     * @see mysql_result::fetchAllArray()
    */
    function getArray(){
        return $this->fetchAllArray();
    }
